export default {
  tomxu: {
    ...
    modal_transfer_tomxu: {
      ...
      message: 'Ghi chú',
      message_placeholder: 'Nhắn đến người nhận',
      amount: 'Số lượng',
    ...
    ptomxu_detail:
      ...
      'Nếu trong vòng 30 ngày tính từ thời điểm hết hạn của gói thành viên gần nhất, bạn không gia hạn(mua lại gói) => số dư P còn lại trong tài khoản sẽ bị thu hồi.<br/>' +
      'Toàn bộ P bị thu hồi sẽ được chuyển thành CP và chuyển về 4 qũy đồng chia theo tỷ lệ 10%-20%-30%-40%.'
  }
}
